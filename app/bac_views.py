...
# Créer un blueprint pour le calcul du BAC
bac_views = Blueprint('bac_views', __name__)
...
# Route principale pour l'interface utilisateur du BAC
@bac_views.route("/bac", methods=["GET", "POST"])
def bac():
